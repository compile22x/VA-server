...
function fn_onClose_Handler() {
    ...
    const protocol = global.m_serverconfig.m_configuration.enable_SSL === true ? 'wss' : 'ws';
    const c_url = `${protocol}://${global.m_serverconfig.m_configuration.s2s_ws_target_ip}:${global.m_serverconfig.m_configuration.s2s_ws_target_port}`;
